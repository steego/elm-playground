...
var _user$project$Main$render = function (json) {
	var _p0 = json;
	switch (_p0.ctor) {
		case 'JsonNull':
			return A2(
							...
							{ctor: '[]'},
							{
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _user$project$Main$render(_p2._1),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
						...
						return A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _user$project$Main$render(item),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							});
...
var _user$project$Main$decodeTextArea = A2(_elm_lang$core$Json_Decode$field, 'value', _elm_lang$core$Json_Decode$string);
var _user$project$Main$onChange = function (msg) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'input',
		A2(_elm_lang$core$Json_Decode$map, msg, _user$project$Main$decodeTextArea));
};
...
var _user$project$Main$init = {input: '{ \"x\": 5 }'};
var _user$project$Main$Model = function (a) {
	return {input: a};
};
var _user$project$Main$ChangeText = function (a) {
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$ChangeText),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
...
var _user$project$Main$JsonNull = {ctor: 'JsonNull'};
var _user$project$Main$testCase = _user$project$Main$JsonList(
	{
		ctor: '::',
		_0: _user$project$Main$JsonNull,
		_1: {
			ctor: '::',
			_0: _user$project$Main$JsonBool(false),
			_1: {
				ctor: '::',
				_0: _user$project$Main$JsonString('Hello Meetup!!!'),
				_1: {
					ctor: '::',
					_0: _user$project$Main$JsonNumber(123),
					_1: {
						ctor: '::',
						_0: _user$project$Main$JsonObject(
							{
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									_0: 'x',
									_1: _user$project$Main$JsonNumber(12)
								},
								_1: {
									ctor: '::',
									_0: {
										ctor: '_Tuple2',
										_0: 'y',
										_1: _user$project$Main$JsonString('test')
									},
									_1: {ctor: '[]'}
								}
							}),
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"ChangeText":["String"]}}},"aliases":{},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
